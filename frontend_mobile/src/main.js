...
} else if (window.location.pathname == '/site_list' || window.location.pathname == '/' || window.location.pathname == '/notification' || window.location.pathname == '/other/subscribe' || window.location.pathname == '/forum_home' || window.location.pathname.indexOf('/recommend/') == 0 || window.location.pathname.indexOf('/center/') == 0) {
  const httpLink = new HttpLink({
    // You should use an absolute URL here
    uri: GRAPHQL_API_URL,
    headers: {
