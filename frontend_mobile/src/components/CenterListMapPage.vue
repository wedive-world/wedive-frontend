  ...
  <div class="" style="height: 100%; !important">
    ...
    <div class="page-content pb-0" style="height: 100% !important;">
        <div class="wedive-action text-center" style="z-index: 99;">
            ...
            <a href="/center_list" class="action-list"><span>목록</span></a>
        </div>
                    ...
                    <div class="justify-content-center mb-0 text-start">
                        ...
                        <div class="" style="padding-left: 110px;">
                            ...
                            <p class="pb-0 mb-0 mt-n1"><i class="fa fa-star font-13 color-yellow-dark scale-box"></i>
                                ...
                                <img id="map_box_shop_fed" src="https://d34l91104zg4p3.cloudfront.net/agency/logo_padi.svg" height="14" class="ext-img mt-n1" style="filter: grayscale(100%) contrast(0.5);">
                                &nbsp;<font class="color-gray-light">|</font>&nbsp;
                        ...
                        <div class="list-group list-custom-small list-icon-0 check-visited">
                            <div class="form-check icon-check">
                                ...
                                <div class="form-check icon-check">
                                    ...
                                    <label class="form-check-label" for="check_scuba">스쿠바 다이빙</label>
...
export default {
  ...
  mounted() {
    ...
    // script.onload = () => {
        ...
        var center_list = [
            {title: "버블탱크 스쿠바다이빙", desc: "제주 남부에 위치한 PADI 5star 다이빙센터", star: 3.8, price_index: 2, feature: "덕다이빙, 케이브, 난파선, 드리프트", img: '', position: {lat: 33.24134444312815, lng: 126.56484940647604}},
        ...
        for (var i=0; i<center_list.length; i++) {
            const img_path = 'https://d34l91104zg4p3.cloudfront.net/assets/' + ( (center_list[i].hasOwnProperty("type") && center_list[i].type == 'selected') ? 'ico_pin_big1.png' : 'ico_pin2.png');
            ...
            marker_shop.addListener("click", () => {
                ...
                marker_shop.setIcon(new google.maps.MarkerImage('https://d34l91104zg4p3.cloudfront.net/assets/ico_pin_big1.png', null, null, null, new google.maps.Size(58,66)));
...
.action-list:before {clear: both;content: "";display: inline-block;margin-right: 6px;width: 14px;height: 14px;background-size: 14px 14px;background-repeat: no-repeat;background-image: url(https://d34l91104zg4p3.cloudfront.net/assets/icon_list.png);text-indent: -9999px;vertical-align: middle;}
