    ...
    <div class="page-content">
        ...
        <div class="card card-style" style="margin-top:-60px; z-index:1">
            <div class="text-center" style="padding:30px 10px;">
                ...
                <p class="color-gray m-0"><i class="fas fa-map-marked-alt" ></i> 대한민국 제주 사이트</p>
                ...
                <div class="star-area mt-1">
                    ...
                    <i class="fas fa-eye font-20 color-gray-light-mid2 scale-box"></i>
                    <i class="fas fa-eye font-20 color-gray-light-mid2 scale-box"></i>
                    <i class="fas fa-eye font-20 color-gray-light-mid2 scale-box"></i>
        ...
        <div class="card card-style p-2">
            <div class="content mb-2">
                ...
                <div class="justify-content-center mb-2 mt-3 text-start">
                    <div class="mb-2">
                        서귀포 하면 가장 먼저 떠오르는 다이빙 포인트! 물때에 따라 다른 방향으로 흘러가는 조류 다이빙, 다양한 연산호와 물고기들이 어우러진 곳이다. 서귀포항에서 배를 타고 5분 정도면 다다를 수 있을정도로 가까운 섬이며, 도지정 문화재 기념물로 보호되고 있다.
                    </div>
                </div>
