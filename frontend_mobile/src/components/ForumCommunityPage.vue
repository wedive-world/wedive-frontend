                ...
                <div class="pe-3 ps-3 pt-2 pb-2 border-bottom">
                    <div class="user-img me-2">
                        <svg class="svg-profile" viewBox="0 0 88 88" preserveAspectRatio="xMidYMid meet">
                            ...
                            <image class="user-photo" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" clip-path="url(#clipSquircle)" xlink:href="/static/images/diving_advanced.jpg"/>
                        </svg>
                    </div>
