                    ...
                    <div class="splide__slide">
                        ...
                        <div class="content mt-1">
                            ...
                            <vue-typeahead-bootstrap
                                ...
                                <template slot="suggestion" slot-scope="{ data, htmlText }">
                                    ...
                                    <span v-if="data.__typename == 'DiveSite'" class="ml-4" style="margin-top: -20px;" v-html="'<span class=\'font-noto font-16\'>' + htmlText + '</span><span class=\'font-13 ms-2\'>(<i class=\'fa fa-star color-gray-light icon-10 text-center me-1\'></i>'+(data.adminScore/20).toFixed(1)+')</span><br/><span class=\'ellipsis\' style=\'width: calc(100% - 50px);position: absolute;margin-top:-4px;\'>' + (data.description ? data.description : '')+'</span>'"></span>
                                    <span v-else-if="data.__typename == 'DivePoint'" class="ml-4" style="margin-top: -20px;" v-html="'<span class=\'font-noto font-16\'>' + htmlText + '</span><span class=\'font-13 ms-2\'>(<i class=\'fa fa-star color-gray-light icon-10 text-center me-1\'></i>'+(data.adminScore/20).toFixed(1)+')</span><br/><span class=\'ellipsis\' style=\'width: calc(100% - 50px);position: absolute;margin-top:-4px;\'>' + (data.description ? data.description : '')+'</span>'"></span>
                            ...
                            <div 
                                ...
                                <span v-if="search_type == 'DiveSite'" class="ml-4" style="margin-top: -20px;" v-html="'<span class=\'font-noto font-16\'>' + search_loc + '</span><span class=\'font-13 ms-2\'>(<i class=\'fa fa-star color-gray-light icon-10 text-center me-1\'></i>'+(search_adminScore/20).toFixed(1)+')</span><br/><span class=\'ellipsis\' style=\'width: calc(100% - 50px);position: absolute;margin-top:-4px;\'>' + (search_desc ? search_desc : '')+'</span>'"></span>
                                <span v-else-if="search_type == 'DivePoint'" class="ml-4" style="margin-top: -20px;" v-html="'<span class=\'font-noto font-16\'>' + search_loc + '</span><span class=\'font-13 ms-2\'>(<i class=\'fa fa-star color-gray-light icon-10 text-center me-1\'></i>'+(search_adminScore/20).toFixed(1)+')</span><br/><span class=\'ellipsis\' style=\'width: calc(100% - 50px);position: absolute;margin-top:-4px;\'>' + (search_desc ? search_desc : '')+'</span>'"></span>
                        ...
                        <div v-if="nearList.length>0" class="content mt-1">
                            ...
                            <div
                                ...
                                <span v-if="item.type == 'site'" class="ml-4" style="margin-top: -20px;" v-html="'<span class=\'font-noto font-16\'>' + item.name + '</span><span class=\'font-13 ms-2\'>(<i class=\'fa fa-star color-gray-light icon-10 text-center me-1\'></i>'+(item.adminScore/20).toFixed(1)+')</span><br/><span class=\'ellipsis\' style=\'width: calc(100% - 144px);position: fixed;margin-top: -4px;\'>' + (item.description ? item.description : '')+'</span>'"></span>
                                <span v-else-if="item.type == 'point'" class="ml-4" style="margin-top: -20px;" v-html="'<span class=\'font-noto font-16\'>' + item.name + '</span><span class=\'font-13 ms-2\'>(<i class=\'fa fa-star color-gray-light icon-10 text-center me-1\'></i>'+(item.adminScore/20).toFixed(1)+')</span><br/><span class=\'ellipsis\' style=\'width: calc(100% - 144px);position: fixed;margin-top: -4px;\'>' + (item.description ? item.description : '')+'</span>'"></span>
