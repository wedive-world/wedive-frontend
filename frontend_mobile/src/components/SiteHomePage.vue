    ...
    <div class="page-content">
        ...
        <div v-on:click="goList()" class="card card-style" style="background: white;height:148px;">
            <div class="content mb-0 mt-3">
                <img class="float-right" src="https://image-bucket.us-east-1.linodeobjects.com/image/save_earth.png" style="position: absolute;z-index: 11;right: 10px;top:40px;"/>
        ...
        <div class="card card-style " style="background-image: url(https://image-bucket.us-east-1.linodeobjects.com/image/autumn_back.jpg);background-size: cover;background-repeat: no-repeat;">
            <div class="content mb-0 mt-3">
                ...
                <img class="mt-n2 float-left" src="https://image-bucket.us-east-1.linodeobjects.com/image/smartwatch.png" style="margin-left:-20px;padding-top:20px;padding-bottom:16px;"/>
        ...
        <div class="card card-style" style="background: #f086a2;">
            <div class="content mb-0 mt-3">
                ...
                <a class="color-white font-12 opacity-60 wedive-txt-all">보러가기 <i class="wedive_icoset wedive_icoset_rightarrow" style="-webkit-background-size: 393px 16px;background-size: 393px 16px;width: 16px;height: 20px;background-position: -375px 0px;"></i></a>
                <img class=" mt-n4 float-right" src="https://image-bucket.us-east-1.linodeobjects.com/image/camera.png" style="margin-right: 16px;margin-bottom:16px;"/>
            </div>
        </div>
        ...
        <div class="card card-style" style="background: #beb8b1;">
            <div class="content mb-0 mt-3">
                ...
                <a class="color-white font-12 opacity-60 wedive-txt-all">보러가기 <i class="wedive_icoset wedive_icoset_rightarrow" style="-webkit-background-size: 393px 16px;background-size: 393px 16px;width: 16px;height: 20px;background-position: -375px 0px;"></i></a>
                <img class="mt-n2 mb-2 float-right" src="https://image-bucket.us-east-1.linodeobjects.com/image/pool.png" width="240"/>
            </div>
        </div>
        ...
        <div class="card card-style" style="background: #2885df;">
            <div class="content mb-0 mt-3">
                ...
                <a class="color-white font-12 opacity-60 wedive-txt-all">보러가기 <i class="wedive_icoset wedive_icoset_rightarrow" style="-webkit-background-size: 393px 16px;background-size: 393px 16px;width: 16px;height: 20px;background-position: -375px 0px;"></i></a>
                <img class="float-right mt-n3 movebox" src="https://image-bucket.us-east-1.linodeobjects.com/image/boat.png" style="padding-bottom:16px;"/>
        ...
        <div class="card card-style" style="background: #28344e;height:240px;">
            <div class="content mb-0 mt-3">
                ...
                <a class="color-white font-12 opacity-60 wedive-txt-all">보러가기 <i class="wedive_icoset wedive_icoset_rightarrow" style="-webkit-background-size: 393px 16px;background-size: 393px 16px;width: 16px;height: 20px;background-position: -375px 0px;"></i></a>
                <img class="float-right" src="https://image-bucket.us-east-1.linodeobjects.com/image/whale.png" />
            </div>
        </div>
