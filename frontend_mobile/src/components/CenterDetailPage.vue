  ...
  <div class="">
    ...
    <div class="page-content" style="padding-bottom: 50px;">
                ...
                <div data-bs-parent="#tab-group-2" class="collapse px-2" id="tab-eqpt">
                    <div class="mt-3 text-start row" v-if="getDiveCenterByUniqueName.rentals && getDiveCenterByUniqueName.rentals.length > 0">
                        <div class="ico_equipt col-3" v-for="rental in getDiveCenterByUniqueName.rentals">
                            <i :class="'ico_equipt' + (rentalOptions.findIndex(x=>rental.name.includes(x))+1) + ' icon-equiptment'"></i>
        ...
        <div class="card card-style">
            ...
            <a :href="'/review2/'+getDiveCenterByUniqueName._id" class="color-highlight font-12 wedive-txt-all">모두보기</a>
            <div class="divider mt-3 mb-2"></div>
                    ...
                    <div class="splide__track">
                        <div class="splide__list">
                            ...
                            <div class="splide__slide">
                                <a :href="'/review2/'+getDiveCenterByUniqueName._id">
                                <div class="min-h-230 p-2">
        ...
        <div id="footer-bar-shop" class="hide d-flex" style="min-height: 52px !important;height: 52px !important;">
            <div class="flex-fill speach-input pt-2 pb-2 ps-4 pe-4">
                <div class="row">
                    <a v-if="getDiveCenterByUniqueName.uniqueName == 'k26'" href="https://m.k-26.com/reservation/reserved_user.php" class="col-6 btn btn-full rounded-s shadow-l gradient-highlight color-white bd-w-0 font-noto font-500"><i class="fas fa-calendar-check me-2"></i>예약</a>
                    <a v-else data-menu="menu-reservation" :class="(getDiveCenterByUniqueName.isBookable == null || getDiveCenterByUniqueName.isBookable == true ? '' : 'hide') + ' btn btn-full font-400 rounded-s shadow-l gradient-highlight color-white bd-w-0 font-noto font-500'" style="width: calc(50% - 6px);margin-right:6px;"><i class="fas fa-calendar-check me-2"></i>예약</a>
                    <a v-on:click="findBuddyClick()" :class="(getDiveCenterByUniqueName.isBookable == null || getDiveCenterByUniqueName.isBookable == true ? 'col-6' : 'col-12') + ' btn btn-full font-400 rounded-s shadow-l gradient-highlight color-white bd-w-0 font-noto font-500'" :style="(getDiveCenterByUniqueName.isBookable == null || getDiveCenterByUniqueName.isBookable == true ? 'width: calc(50% - 6px);margin-left:6px;' : '')"><i class="fas fa-user-friends me-2"></i>버디모집</a>
                </div>
            </div>
        </div>
    </div>
...
export default {
  ...
  apollo: {
      getDiveCenterByUniqueName: {
          ...
          `,
          skip() {
              return (this.getDiveCenterByUniqueName && this.getDiveCenterByUniqueName._id ? true : false)
          },
          variables() {
              return {
          ...
          result() {
            ...
            this.$apollo.query({
                ...
                // Parameters
                variables: {
                    placeId: this.getDiveCenterByUniqueName._id
                },
            }).then((data) => {
                // Result
