...
.action-map:before {clear: both;content: "";display: inline-block;margin-right: 6px;width: 14px;height: 14px;background-size: 14px 14px;background-repeat: no-repeat;background-image: url(https://image-bucket.us-east-1.linodeobjects.com/image/icon_map.png);text-indent: -9999px;vertical-align: middle;}
