    ...
    <div class="page-content pb-3"> 
        <div class="text-center mt-3 mb-3">
            <div id="file-upload1-back" :style="'border: 1px solid #abb7ba;width: 152px;height:152px;display: inline-block;position: relative;' + ((userData && userData.profileImages && userData.profileImages.length > 0) ? 'background:url('+userData.profileImages[0].thumbnailUrl+');background-size: cover;' : '')">
                ...
                <p id="file-upload1-img" :class="'upload-file-text' + ((userData && userData.profileImages && userData.profileImages.length > 0) ? ' opacity-0': '')" style="color: #abb7ba;position:absolute;left:40px;top:76px;"><img src="https://d34l91104zg4p3.cloudfront.net/assets/icon_image2.png" height="80" style="filter: brightness(.7);"/></p>
            </div>
        </div>
