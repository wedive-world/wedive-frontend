<template>
  <div class="">
    ...
    <div class="sch_background">
      ...
      <img class="sb_img" src="https://d34l91104zg4p3.cloudfront.net/assets/mobile_back.png" />
      </div>
    ...
    <img v-on:click="goHome()" class="logo-image" style="position:absolute;top:0;top:30px;left: 50%;transform: translate(-50%, -50%);" src="https://d34l91104zg4p3.cloudfront.net/assets/logo-light.svg" height="50"/>
    <div class="page-content">
        ...
        <div class="card card-style" style="background: white;height:134px;">
            <div class="content mb-0 mt-1">
                ...
                <img class="float-right" src="https://d34l91104zg4p3.cloudfront.net/assets/listening-music.png" width="90" style="position: absolute;z-index: 11;right: 0px;bottom:0px;"/>
        ...
        <div v-on:click="goStatic()" class="card card-style" style="background: #ffae58;">
            <div class="content mb-0 mt-3 text-center">
                <img src="https://d34l91104zg4p3.cloudfront.net/assets/cap.png" width="140" style="margin-top:6px;margin-bottom:10px;"/>
        ...
        <div v-on:click="goStatic()" class="card card-style" style="background: #f1c95f;">
            <div class="content mb-0 mt-3 text-center">
                <img src="https://d34l91104zg4p3.cloudfront.net/assets/wedive_choice.png" width="200"/>
                <h4 class="pt-1 mb-0">가을, 떠나기 좋은 다이빙 포인트</h4>
                <p class="mb-3 opacity-50">위다이브 선정 가을 여행지 TOP 10을 만나보세요.</p>
                <img src="https://d34l91104zg4p3.cloudfront.net/assets/people.png" width="260"/>
            </div>
        </div>
