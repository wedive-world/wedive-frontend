                            ...
                            <div class="bx mt-3 mb-3">
                                <div class="justify-content-center mb-0 text-start">
                                    <div style="float: left;position: relative;width: 75px; height:75px;">
                                        <div class="thumb-img me-2">
                                            <svg class="svg-profile" viewBox="0 0 88 88" preserveAspectRatio="xMidYMid meet">
                                                ...
                                                <image class="user-photo" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" clip-path="url(#clipSquircle)" :xlink:href="(item.images && item.images.length>0) ? item.images[0].thumbnailUrl : '/static/empty.jpg'"/>
                                            </svg>
                                        </div>
                                    ...
                                    <div :class="item.__typename" style="display:inline-block;vertical-align: top;width: calc(100vw - 130px);margin-left:16px;min-height:80px;padding-top:8px;">
                                        <span class="font-18 pb-0 font-600"> {{item.title}} <span class="pb-0 mb-0 mt-n1 font-13 color-gray"><i class="fa fa-users"></i> {{ item.users.length }}</span></span>
                                        <p class="pb-0 mb-0 mt-1 line-height-s ellipsis2"> {{ (item.description == '') ? '&nbsp;' : item.description }} </p>
                                    </div>
                                </div>
                            </div>
                        </a>
...
export default {
  ...
  methods: {
      ...
      async lookupUser3() {
        ...
        this.users = result.data.data.searchCommunities;
