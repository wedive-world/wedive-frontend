        ...
        <div v-if="divingInfo" v-on:click="moveDiving(divingInfo)" class="font-noto" style="margin-top: 50px;height:90px;border-bottom:1px solid lightgray;padding:14px;position:relative;">
            ...
            <div class="thumb-img me-2" style="position:absolute;right:14px;top:14px;">
                <svg class="svg-profile" viewBox="0 0 88 88" preserveAspectRatio="xMidYMid meet">
                    ...
                    <image class="user-photo" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" clip-path="url(#clipSquircle)" :xlink:href="(divingInfo.diveLocation && divingInfo.diveLocation.length > 0 && divingInfo.diveLocation[0].backgroundImages && divingInfo.diveLocation[0].backgroundImages.length > 0) ? divingInfo.diveLocation[0].backgroundImages[0].thumbnailUrl : '/static/empty.jpg'"/>
                </svg>
            </div>
