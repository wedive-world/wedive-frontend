<template>
  <div class="">
    ...
    <div class="page-content">
        ...
        <div class="card card-style">
            <div class="content mb-0 mt-3">
                <h4 class="text-start pt-2 mb-0">신청 즉시 확정되는<br/>1인 예약</h4>
                <p class="mb-3 color-gray-light-mid">31개의 다이빙 이벤트</p>
                <a class="color-highlight font-12 wedive-txt-all">모두보기</a>
        ...
        <div class="card card-style">
            <div class="content mb-0 mt-3">
                <h4 class="text-start pt-2 mb-0">수도권 지역 다이빙</h4>
                <p class="mb-3 color-gray-light-mid">271개의 다이빙 이벤트</p>
                <a class="color-highlight font-12 wedive-txt-all">모두보기</a>
        ...
        <div class="card card-style">
            <div class="content mb-0 mt-3">
                <h4 class="text-start pt-2 mb-0">3박 이상<br/>연박 다이빙</h4>
                <p class="mb-3 color-gray-light-mid">162개의 다이빙 이벤트</p>
                <a class="color-highlight font-12 wedive-txt-all">모두보기</a>
  ...
  data () {
    return {
      ...
      handleScroll: function(event) {
          var current_driection = (this.oldScroll > window.pageYOffset);
          if (current_driection != this.prev_driection && current_driection == true) {
              $("#btn_new").html(this.btn_new_html.replace('</i>', '&nbsp;이벤트 생성</i>'));
              $("#btn_new").css("width", "auto");
          } else if (current_driection != this.prev_driection && current_driection == false) {
              $("#btn_new").html(this.btn_new_html);
              $("#btn_new").css("width", "48px");
          }
          this.prev_driection = current_driection;
