    ...
    <div class="page-content">
        ...
        <div class="card card-style">
            <div class="content mb-0 mt-3">
                <h4 class="text-start pt-2 mb-3">따끈따끈 신규 다이빙</h4>
                <a class="color-highlight font-12" style="margin-top: -40px;padding-bottom: 10px;float:right;">모두보기</a>
                ...
                <div class="light-border-bottom mt-3">
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div class="text-start align-self-center">
                            ...
                            <p class="color-highlight font-13 mb-0 ellipsis"><i class="wedive_icoset wedive_icoset_marker"></i> 양양포인트 (대한민국 강원 사이트)</p>
                            <p class="color-secondary font-13 mb-0 ellipsis">#카풀가능 #센터확정 #개별숙박</p>
                        </div>
                    </div>
                </div>
                <div class="light-border-bottom mt-3">
                    <span class="chip chip-s bg-fade-magenta-light color-magenta-dark-more text-center font-600 wedive-chip">3자리 남음</span>
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div class="text-start align-self-center">
                            ...
                            <p class="color-highlight font-13 mb-0 ellipsis"><i class="wedive_icoset wedive_icoset_marker"></i> 서귀포포인트 (대한민국 제주 사이트)</p>
                            <p class="color-secondary font-13 mb-0 ellipsis">&nbsp;</p>
                        </div>
                    </div>
                </div>
                <div class="light-border-bottom mt-3">
                    <span class="chip chip-s bg-fade-magenta-light color-magenta-dark-more text-center font-600 wedive-chip">1자리 남음</span>
                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div class="text-start align-self-center">
                            ...
                            <p class="color-highlight font-13 mb-0 ellipsis"><i class="wedive_icoset wedive_icoset_marker"></i> 문섬포인트 (대한민국 제주 사이트)</p>
