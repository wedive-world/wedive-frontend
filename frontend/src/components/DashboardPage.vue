  ...
  <div class="">
    ...
    <section class="parallax-section dashboard-header-sec gradient-bg" data-scrollax-parent="true">
        <div class="container">
            ...
            <!--Tariff Plan menu-->
            <div class="tfp-btn hide"><span>Tariff Plan : </span> <strong>Extended</strong></div>
            <div class="tfp-det">
            ...
            <div class="container">
                <div class="dashboard-header_conatiner fl-wrap">
                    <div class="dashboard-header-avatar">
                        <img src="/static/images/ico_wedive_d.png" alt="">
                    ...
                    <a class="add_new-dashboard hide">Add Listing <i class="fal fa-layer-plus"></i></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="user-profile-menu-wrap fl-wrap block_box">
                        ...
                        <div class="user-profile-menu">
                            ...
                            <ul class="no-list-style">
                                <li><a href=""><i class="fal fa-chart-line"></i>대시보드</a></li>
                                <li><a href=""><i class="fal fa-rss"></i>예약현황 <span>7</span></a></li>
                        ...
                        <div class="user-profile-menu">
                            ...
                            <ul  class="no-list-style">
                                ...
                                <li><a id="dash_site_manage" href="/dashboard/site_manage" class=""><i class="fal fa-file-plus"></i> 사이트 관리</a></li>
                                <li><a id="dash_poing_manage" href="/dashboard/point_manage" class=""><i class="fal fa-file-plus"></i> 포인트 관리</a></li>
                                <!--<li>
                                    <a href="#" class="submenu-link"><i class="fal fa-plus"></i>Submenu</a>
                                    <ul  class="no-list-style">
                                        <li><a href="#"><i class="fal fa-th-list"></i> Submenu 2 </a></li>
