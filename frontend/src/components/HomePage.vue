    ...
    <section class="hero-section"   data-scrollax-parent="true">
        <div class="bg-tabs-wrap">
            <div class="bg-parallax-wrap" data-scrollax="properties: { translateY: '200px' }">
                <div class="bg bg_tabs"  data-bg="/static/images/bg/hero/buddy.jpg"></div>
        ...
        <div class="container small-container">
            <div class="intro-item fl-wrap">
                ...
                <h3>새로운 친구와 다이빙을 즐겨보세요.</h3>
            </div>
            <!-- main-search-input-tabs-->
            <div class="main-search-input-tabs  tabs-act fl-wrap">
                <ul class="tabs-menu change_bg no-list-style">
                    <li class="current"><a href="#tab-inpt1" data-bgtab="/static/images/bg/hero/buddy.jpg" data-bgtitle="다이빙 버디 찾기" data-bgsubtitle="새로운 친구와 다이빙을 즐겨보세요."> 다이빙 버디</a></li>
                    <li><a href="#tab-inpt2" data-bgtab="/static/images/bg/hero/training.jpg" data-bgtitle="다이빙 교육 찾기" data-bgsubtitle="안전을 책임지는 교육을 찾아보세요."> 다이빙 교육</a></li>
                    <li><a href="#tab-inpt3" data-bgtab="/static/images/bg/hero/center.jpg" data-bgtitle="다이빙 센터 찾기" data-bgsubtitle="새로운 곳으로 떠나보세요."> 다이빙 센터</a></li>
                </ul>
                <!--tabs -->                       
            ...
            <div class="hero-categories fl-wrap hide">
                                        ...
                                        <div class="geodir-category-img">
                                            ...
                                            <div class="geodir-category-opt">
                                                ...
                                                <div class="listing_carditem_footer fl-wrap">
                                                    ...
                                                    <div class="post-author"><a href="#"><img src="/static/images/avatar/1.jpg" alt=""><span>By , Alisa Noory</span></a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="geodir-category-img">
                                            ...
                                            <div class="geodir-category-opt">
                                                ...
                                                <div class="listing_carditem_footer fl-wrap">
                                                    ...
                                                    <div class="post-author"><a href="#"><img src="/static/images/avatar/1.jpg" alt=""><span>By , Mark Rose</span></a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="geodir-category-img">
                                            ...
                                            <div class="geodir-category-opt">
                                                ...
                                                <div class="listing_carditem_footer fl-wrap">
                                                    ...
                                                    <div class="post-author"><a href="#"><img src="/static/images/avatar/1.jpg" alt=""><span>By , Nasty Wood</span></a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                                        ...
                                        <div class="geodir-category-img">
                                            ...
                                            <div class="geodir-category-opt">
                                                ...
                                                <div class="listing_carditem_footer fl-wrap">
                                                    ...
                                                    <div class="post-author"><a href="#"><img src="/static/images/avatar/1.jpg" alt=""><span>By , Kliff Antony</span></a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </article>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="listing-item-grid">
                            <div class="bg"  data-bg="/static/images/all/1.jpg"></div>
                                ...
                                <div class="geodir-category-footer fl-wrap">
                                    ...
                                    <div class="geodir-opt-list">
                                        <ul class="no-list-style">
                                            ...
                                            <li>
                                                <div class="dynamic-gal gdop-list-link" data-dynamicPath="[{'src': '/static/images/all/1.jpg'},{'src': '/static/images/all/1.jpg'}, {'src': '/static/images/all/1.jpg'}]"><i class="fal fa-search-plus"></i><span class="geodir-opt-tooltip">Gallery</span></div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="price-level geodir-category_price">
                                ...
                                <div class="geodir-category-footer fl-wrap">
                                    ...
                                    <div class="geodir-opt-list">
                                        <ul class="no-list-style">
                                            ...
                                            <li>
                                                <div class="dynamic-gal gdop-list-link" data-dynamicPath="[{'src': '/static/images/all/1.jpg'},{'src': '/static/images/all/1.jpg'}]"><i class="fal fa-search-plus"></i><span class="geodir-opt-tooltip">Gallery</span></div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="price-level geodir-category_price">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="collage-image">
                        <img src="/static/images/api.png" class="main-collage-image" alt="">                               
                        <div class="images-collage-title color2-bg icdec"> <img src="/static/images/logo.png"   alt=""></div>
                        <div class="images-collage_icon green-bg" style="right:-20px; top:120px;"><i class="fal fa-thumbs-up"></i></div>
                        <div class="collage-image-min cim_1"><img src="/static/images/api/1.jpg" alt=""></div>
                        <div class="collage-image-min cim_2"><img src="/static/images/api/1.jpg" alt=""></div>
    ...
    <section>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testi-item fl-wrap">
                                <div class="testi-avatar"><img src="/static/images/avatar/1.jpg" alt=""></div>
        ...
        <div class="waveWrapper waveAnimation">
          <div class="waveWrapperInner bgMiddle">
            <div class="wave-bg-anim waveMiddle" style="background-image: url('/static/images/wave-top.png')"></div>
          </div>
          <div class="waveWrapperInner bgBottom">
            <div class="wave-bg-anim waveBottom" style="background-image: url('/static/images/wave-top.png')"></div>
          </div>
        </div> 						
    </section>
    <!--section end-->                
                ...
                <div class="clients-carousel">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <!--client-item-->
                            <div class="swiper-slide">
                                <a href="#" class="client-item"><img src="/static/images/clients/1.png" alt=""></a>
                            </div>
                            <!--client-item end-->
                            <!--client-item-->
                            <div class="swiper-slide">
