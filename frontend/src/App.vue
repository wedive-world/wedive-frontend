    ...
    <!--loader-->
        ...
        <div id="main1">
            ...
            <header class="main-header">
                ...
                <div class="show-reg-form modal-open avatar-img" data-srcav="/static/images/avatar/3.jpg"><i class="fal fa-user"></i>Sign In</div>
                <!-- header opt end--> 
                <!-- lang-wrap-->
                <div class="lang-wrap">
                ...
                <div class="header-modal novis_wishlist">
                    ...
                    <div class="header-modal-container scrollbar-inner fl-wrap" data-simplebar>
                        ...
                        <div class="widget-posts  fl-wrap">
                            <ul class="no-list-style">
                                <li>
                                    <div class="widget-posts-img"><a href="listing-single.html"><img src="/static/images/gallery/thumbnail/1.png" alt=""></a>  
                                    </div>
