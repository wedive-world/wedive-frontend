...
const { query, mutation } = require('@/graphql/driver/gql/dive-site-gql')
...
module.exports.getAllDiveSites = async () => {
  let result = await client.request(query.getAllDiveSites)
  console.log(`getAllDiveSites: sites=${JSON.stringify(result)}`)
  return result;
}